...
public class ClientHandler {
    ...
    private void addToBlackList(String nickToBlock) throws SQLException {
        ...
        String sqlGetUserBlockId = String.format("SELECT id FROM main where nickname = '%s'", nickToBlock);
        ResultSet rsUserBlockId = AuthService.getStmt().executeQuery(sqlGetUserBlockId);
        if (rsUserBlockId.next()) {
            userBlockId = rsUserBlockId.getInt(1);
        }
